...
export { COFNIG_ENV, COFNIG_HOST, CONFIG_DEV_HOST_PORT, CONFIG_ENV_DEVELOPMENT, CONFIG_ENV_LOC, CONFIG_ENV_LOCAL, CONFIG_HOST_LOCAL, CONFIG_PATH_PREFIX, CONFIG_PROD_HOST_PORT, CONFIG_SUB_APP_CWF_HEL_VITE_VUE3_DEMO_HOST, CONFIG_SUB_APP_CWF_HEL_VITE_VUE3_DEMO_HOST_PATCH, CONFIG_SUB_APP_CWF_HEL_VITE_VUE3_DEMO_REMOTE, getConfigHost };
