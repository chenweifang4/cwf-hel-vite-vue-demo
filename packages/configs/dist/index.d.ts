...
export declare const CONFIG_SUB_APP_CWF_HEL_VITE_VUE2_DEMO_HOST_PATCH = "cwf-hel-vite-vue2-demo-host-patch";
export declare const CONFIG_DEV_HOST_PORT: {
    ...
    "cwf-hel-vite-vue2-demo-host-patch": number;
};
...
export declare const CONFIG_PATH_PREFIX: {
    ...
    "cwf-hel-vite-vue2-demo-host-patch": string;
};
